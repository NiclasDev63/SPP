        ...
        for(int y = 0; y < 3; y++) {
            for(int x = 0; x < 3; x++) {
                ...
                if(current_row != empty_row) {
                    ...
                    // set encrypted row to empty if current row is empty
                else {
                    encrypted_row = current_row;
                }
                ...
                if(y != 0 || x != 0) {
                    ...
                    for (int eY = 0; eY <= y; eY++) {
                        for (int eX = 0; eX < 3; eX++) {
                            ...
                            if (eY == y && eX == x)
                                break;
                            encrypted_row = row_wise ?  combine_rows(encrypted_row, encrypted_block[eY][eX]) :
                                            combine_rows(encrypted_row, encrypted_block[eX][eY]);
